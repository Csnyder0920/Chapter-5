...
Public Class frmRPS
    ...
    Private Sub btnShoot_Click(sender As Object, e As EventArgs) Handles btnShoot.Click
        ...
        If radRock.Checked = True And Rock = Num Then
            lblResult.Text = "Computer Chose Rock too! You Tie!"
        ElseIf radRock.Checked = True And Paper = Num Then
            lblResult.Text = "Computer Chose Paper! You Lose!"
            NumCount += 1
        ElseIf radRock.Checked = True And Scissors = Num Then
            lblResult.Text = "Computer Chose Scissors! You Win!"
            intUserCount1 += 1
        End If

        If radPaper.Checked = True And Rock = Num Then
            lblResult.Text = "Computer Chose Rock! You Win!"
            intUserCount1 += 1
        ElseIf radPaper.Checked = True And Paper = Num Then
            lblResult.Text = "Computer Chose Paper! You Tie!"
        ElseIf radPaper.Checked = True And Scissors = Num Then
            lblResult.Text = "Computer Chose Scissors! You Lose!"
            NumCount += 1
        End If
        If radScissors.Checked = True And Rock = Num Then
            lblResult.Text = "Computer Chose Rock!You Lose!"
        ElseIf radScissors.Checked = True And Paper = Num Then
            lblResult.Text = "Computer Chose Paper!You Win!"
            intUserCount1 += 1
        ElseIf radScissors.Checked = True And Scissors = Num Then
